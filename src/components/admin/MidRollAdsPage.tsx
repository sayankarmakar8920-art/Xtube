...
function StatCard({
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-[20px] border border-[#1A1A1A] bg-[#0B0B0F] p-3 lg:p-4 transition-all duration-300 hover:border-white/10 hover:shadow-lg"
    >
      {/* Top accent line */}
      ...
      <div className="min-h-full p-3 lg:p-5 xl:p-6 space-y-4">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {/* Date range */}
            <button className="flex items-center gap-2 rounded-[20px] border border-[#1A1A1A] bg-[#0B0B0F] px-3 py-2 text-xs font-medium text-white/60 transition-colors hover:border-white/20 hover:text-white">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="flex items-center gap-2 rounded-[20px] bg-[#FF0000] px-4 py-2 text-sm font-semibold text-white shadow-[0_0_15px_rgba(255,0,0,0.3)] transition-all hover:bg-red-600"
            >
        ...
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1fr_1fr_300px] 2xl:grid-cols-[1fr_1fr_340px]">
          ...
          <motion.div
            ...
            className="overflow-hidden rounded-[20px] border border-[#1A1A1A] bg-[#0B0B0F]"
          >
            <div className="p-3 lg:p-4">
              ...
              <div className="mb-4 flex items-center gap-0 border-b border-[#1A1A1A]">
                ...
                >
                  ...
                  Video Ad
                  {adTab === 'video' && (
                    <motion.div layoutId="midroll-tab-indicator" className="absolute bottom-0 left-0 right-0 h-[2px] rounded-full bg-[#FF0000]" transition={{ type: 'spring', stiffness: 500, damping: 30 }} />
                  )}
                </button>
                <button
                ...
                {uploadStage === 'idle' ? (
                  ...
                  >
                    ...
                    <p className="text-[10px] text-white/25">
                      Max file size: 5GB | Supported: MP4, MOV, WebM, HLS
                    </p>
                  </motion.div>
            ...
            <div className="overflow-hidden rounded-[20px] border border-[#1A1A1A] bg-[#0B0B0F]">
              <div className="p-3 lg:p-4">
                ...
                <div className="space-y-2.5">
                  {[
                    { icon: Film, label: 'Create Video Mid-Roll Ad', desc: 'Upload a video ad up to 5GB', color: '#FF0000', bgColor: 'from-red-500/10 to-red-600/5' },
                    { icon: ImageIcon, label: 'Create Image Mid-Roll Ad', desc: 'Upload an image ad', color: '#F59E0B', bgColor: 'from-orange-500/10 to-orange-600/5' },
                    { icon: Megaphone, label: 'Manage Mid-Roll Ads', desc: 'View, edit and manage ads', color: '#00FF85', bgColor: 'from-emerald-500/10 to-emerald-600/5' },
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className={`group flex w-full items-center gap-3 rounded-[20px] border border-[#1A1A1A] bg-gradient-to-r ${action.bgColor} p-3 text-left transition-all hover:border-white/10 hover:shadow-lg`}
                    >
          ...
          <div className="p-3 lg:p-4">
            ...
            <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-2">
                <Select value={statusFilter} onValueChange={(v) => { setStatusFilter(v); setCurrentPage(1) }}>
                  <SelectTrigger className="h-8 w-28 rounded-[20px] border-[#1A1A1A] bg-[#050505] text-xs text-white/60 [&_svg]:text-white/30">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-8 w-40 rounded-[20px] border border-[#1A1A1A] bg-[#050505] pl-8 pr-3 text-xs text-white placeholder:text-white/25 outline-none focus:border-[#FF0000]/40"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 flex items-center justify-between border-t border-[#1A1A1A] pt-3">
                ...
                {[1, 2, 3].map((page) => (
                  <button
                    ...
                    className={`flex h-6 w-6 items-center justify-center rounded-md text-[10px] font-medium transition-colors ${
                      page === currentPage ? 'bg-[#FF0000] text-white' : 'text-white/30 hover:bg-white/10 hover:text-white'
                    }`}
                  >
                    {page}
                  </button>
              ...
              <Select value="10" onValueChange={() => {}}>
                <SelectTrigger className="h-6 w-20 rounded-md border-[#1A1A1A] bg-[#050505] text-[10px] text-white/40 [&_svg]:text-white/20">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="border-[#1A1A1A] bg-[#0B0B0F]">
                  <SelectItem value="10" className="text-[10px] text-white focus:bg-white/5">10 / page</SelectItem>
                  <SelectItem value="25" className="text-[10px] text-white focus:bg-white/5">25 / page</SelectItem>
                  <SelectItem value="50" className="text-[10px] text-white focus:bg-white/5">50 / page</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
